...
function setup() {
 ...
 console.log(message)
  ...
  trex.addAnimation("collheight-ided", trex_collided);
...
function draw() {
  ...
  text("HIGHEST SCORE:" + localStorage.getItem('HighestScore'), width/2, 50);
...
function spawnClouds() {
  ...
  if (frameCount % 60 === 0) {
    ...
    cloud.y = Math.round(random(height-80,height-120));
